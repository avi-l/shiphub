...
const SearchFilter: React.FC = () => {
  ...
  return (
    <>
      <div
        className='w-full gap-2 flex-wrap bg-white shadow-drop
       rounded-2xl flex items-center p-4 border-b border-gray-200 text-gray-600'
      >
        <Input
          ...
          inputClassName='bg-white shadow-input h-[38px] rounded-md px-2 mr-2 text-sm border border-gray-200 w-[310px] text-gray-600 focus:outline-none focus:border-gray-500'
        ...
        <Dropdown
          ...
          icon={downArrow}
          buttonClassName='flex font-light  items-center px-4 py-2 rounded-md bg-white border border-gray-300 h-[38px] w-[250px] relative shadow-input'
          iconBoxClassName='hover:bg-customOrange cursor-pointer absolute right-0 flex items-center rounded-r-md bg-customGray flex items-center justify-center w-[48px] h-[38px]'
        ...
        <div className='flex flex-wrap  '>
          <Dropdown
            ...
            buttonClassName='flex font-light ml-2  items-center px-4 py-2 rounded-md bg-white border border-gray-300 text-gray-600 h-[38px] w-[250px] relative shadow-input'
          ...
          <button
            onClick={handleApply}
            className='shadow-input font-bold  h-[37px] uppercase ml-2 px-4 py-1 text-sm text-white bg-customGray rounded-lg hover:bg-customOrange'
          >
            Apply
          </button>
        </div>
